...
public class LoggedInController extends HelloController {
    ...
    public void displayInfo(User currentUser) {
        ...
        if (currentUser.getCorrectEnglishAnswer() == 0 && currentUser.getIncorrectEnglishAnswer() == 0) {
            ...
            percentageEngLabel.setText(round(100 * currentUser.getCorrectEnglishAnswer() / (currentUser.getCorrectEnglishAnswer() + currentUser.getIncorrectEnglishAnswer())) + "%");
        }
        if (currentUser.getCorrectKoreanAnswer() == 0 && currentUser.getIncorrectKoreanAnswer() == 0) {
            percentageKorLabel.setText("0");
        }else {
            percentageKorLabel.setText(round(100 * currentUser.getCorrectKoreanAnswer() / (currentUser.getIncorrectKoreanAnswer() + currentUser.getCorrectKoreanAnswer())) + "%");
        }
    ...
    public void setUser(User user) {
        ...
        if (user.getCorrectEnglishAnswer() == 0 && user.getIncorrectEnglishAnswer() == 0) {
            ...
            percentageEngLabel.setText(round(100 * user.getCorrectEnglishAnswer() / (user.getCorrectEnglishAnswer() + user.getIncorrectEnglishAnswer())) +"%");
        ...
        if (user.getCorrectKoreanAnswer() == 0 && user.getIncorrectKoreanAnswer() == 0) {
            ...
            percentageKorLabel.setText(round(100 * user.getCorrectKoreanAnswer() / (user.getIncorrectKoreanAnswer() + user.getCorrectKoreanAnswer())) +"%");
